describe("Leasers Page", () => {
  ...
  it("has the correct title", () => {
    cy.title().should("equal", "AUM | Leaders")
  })
  ...
  it("go to leader page", () => {
    cy.get(".users-table__row:first").click()
    cy.title().should("equal", "AUM | Jhon Gibson")
    cy.location("href").should("equal", "http://localhost:4200/leaders/155e77ee-ba6d-486f-95ce-0e0c0fb4b919")
  })
})